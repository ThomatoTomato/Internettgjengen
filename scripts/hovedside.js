...
function generateMatch(bildeUrl, bio, navn, alder, linje, activeIn, interests, exphGrad, born) {
  let matchObj = {
...
matches.push(generateMatch("img/profilbilder/E1.jpg", "Monader er egt bare en monoide i kategorien av endofunktorer. Hva er så vanskelig med det?", "Thomas Thorbjørnsen", "21", "Bachelor i matematiske fag","Hackerspace, Realfagsdagene","Monader", "C", "01.05.1999"));
matches.push(generateMatch("https://3.bp.blogspot.com/-99GXeCJkLuE/UXL8mClxm0I/AAAAAAAACUw/JTenHOuNbx0/w1200-h630-p-k-no-nu/bilde.jpg", "Hei, jeg heter Magnus. Hva faen heter du?", "Magnus", "21", "En linje på NTNU", "Orbit NTNU", "BURN: Bruk koden Magnus15 for 15% avslag på Burn.", "B", "13.01.1999"));
matches.push(generateMatch("https://www.fosna-folket.no/incoming/article9783978.ece/ALTERNATES/w380-default/DSC_2420.JPG", "Hei hei hei, jeg heter Martin, hei hei hei hva heter du?", "Martin", "21", "En linje på NTNU", "Kaffedrikker", "løping", "D", "23.03.99"));
matches.push(generateMatch("img/Indok-styret/maren.jpg","Hei, jeg er vennen til Thomas, men jeg er på utkikk etter flere venner. Vil du være vennen min?", "Maren Sandhaug", "21", "Bachelor i informatikk", "Thomas", "Være med Thomas", "A", "08.10.99"));
matches.push(generateMatch("img/Indok-styret/sarah.jpg", "Skapkommunist, ja visst. Vil du bli min comrade?", "Sarah", "22", "En linje på NTNU", "Rød ungdom", "Maos lille røde", "B", "19.10.98"));
